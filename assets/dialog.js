...
function displayDialog(width, height, innerHTML) {
    if (!darken) {
        darken = true;
        document.getElementById('darken').style = "pointer-events: all; background: rgba(0,0,0,0.5); border-radius: 18px; width: " + width + "%; height: " + height + "%; position: fixed; top: 0px; left: 0px; z-index: 15";
